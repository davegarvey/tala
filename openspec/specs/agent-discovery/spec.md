...
Agent discovery in tala: `tala discover` finds tala projects in parent and sibling directories with their daemon status and active participants — so agents can find collaborators across projects without an additional local aggregation command.
